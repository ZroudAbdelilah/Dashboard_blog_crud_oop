  ...
  ?>
    <div id="update-modal">
        <div class="update-modal container mt-5">
          ...
          <div class="form-group">
            <input id="edit-title" placeholder="Title" name="title" type="text" class="form-control">
          </div>
          ...
          <div class="form-group">
            <input id="edit-date" placeholder="xx/xx/xxxx" name="date" type="text" class="form-control">
          </div>
